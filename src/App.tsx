...
import { TeamSection } from './main/TeamSection';
import { FadeInText } from './main/TextAnimation';
...
export default function App() {
  ...
  const handleSignIn = () => {
    ...
    handleRouteChange('/project');
  };

  return (
    <div id="top" className="min-h-screen overflow-x-hidden bg-white pt-[120px]">
          ...
          {isLoading ? (
            ...
            >
              <Navigation
                ...
                collapseOnIdle={isAuthenticated}
              />
              ...
              <main>
                {isAuthenticated ? (
                  <div className="bg-black min-h-screen">
                    <div className="pt-4">
                      <ProjectBoardApp onRouteChange={handleRouteChange} />
                    </div>
                  </div>
                ) : (
                <>
